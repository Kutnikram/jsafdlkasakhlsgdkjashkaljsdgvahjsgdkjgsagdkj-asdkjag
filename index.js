...
client.ayarlar = {
  "prefix": "!", //prefix
  "oauthSecret": "Dy6OzdSlcG-FDBCXdEtwewtXYpPMPAdR", //bot secreti
	"callbackURL": "https://thoughtful-wary-windflower.glitch.me/callback", //benim sitenin urlsini kendin ile değiş "/callback" kalacak!
	"kayıt": "934131064539066398", //onaylandı, reddedildi, başvuru yapıldı falan kayıtların gideceği kanalın ID'ini yazacaksın
  "renk": "BLUE"
};



client.yetkililer = ['664146094183284776',] //tüm yetkililerin ıdleri gelcek array
client.webyetkililer = ['664146094183284776'] //web yetkililerin ıdleri gelcek array
client.sunucuyetkililer = ['664146094183284776'] //sunucu yetkililerin ıdleri gelcek array
    ...
    if (cmd.conf.permLevel === 'ozel') { //o komutu web yetkilileri kullanabsiln sadece diye yaptıgım bişe 
      if (client.yetkililer.includes(message.author.id) === false) {
        const embed = new Discord.RichEmbed()
					.setDescription(`WebSite yetkilisi değilsin saçma saçma işlerle uğraşma!`)
